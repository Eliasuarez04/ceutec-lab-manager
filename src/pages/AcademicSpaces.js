...
export default function AcademicSpaces() {
  const { userData } = useAuth(); // Obtenemos datos del usuario
      ...
      <div className="labs-page-card">
        ...
        <header className="page-header-header">
          ...
          <div className="title-area">
            ...
            {!canReserve && <span style={{fontSize:'0.8rem', color: '#e74c3c'}}>👁️ Solo Lectura (Usuario: {userCity})</span>}
          </div>
        </header>
                ...
                <div key={space.id} className={`lab-card-modern ${getSedeClass(currentSede)}`}>
                  ...
                  <div className="card-actions-row">
                    ...
                    {canReserve ? (
                        ...
                        <button 
                            className="btn-action-primary" 
                            style={{background: '#ccc', cursor: 'not-allowed', border: 'none'}} 
                            disabled
                        >
                            ⛔ Solo {userCity}
                        </button>
